...
- [AgentKit](https://github.com/agentkit/agentkit) - A TypeScript framework for building AI Agents from single inference calls to multi-agent systems using tools.
