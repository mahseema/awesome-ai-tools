...
- [Stable Beluga 2](https://huggingface.co/stabilityai/StableBeluga2) - A finetuned LLamma2 70B model ![Static Badge](https://img.shields.io/badge/model-open_weights-brightgreen)
...
- [MemFree](https://github.com/memfreeme/memfree) - Open Source Hybrid AI Search Engine, Instantly Get Accurate Answers from the Internet, Bookmarks, Notes, and Docs ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)

### Local search engines

- [privateGPT](https://github.com/imartinez/privateGPT) - Ask questions to your documents without an internet connection, using the power of LLMs. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [quivr](https://github.com/StanGirard/quivr) - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [Quick Creator](https://quickcreator.io) - SEO-Optimized Blog platform powered by AI. ![Static Badge](https://img.shields.io/badge/model-open_weights-brightgreen)
...
- [ChatGPT for Jupyter](https://github.com/TiesdeKok/chat-gpt-jupyter-extension) - Add various helper functions in Jupyter Notebooks and Jupyter Lab, powered by ChatGPT. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [editGPT](https://www.editgpt.app/) - Easily proofread, edit, and track changes to your content in chatGPT.
- [Chatbot UI](https://www.chatbotui.com/) - An open source ChatGPT UI. [Source code](https://github.com/mckaywrigley/chatbot-ui). ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [Plandex](https://github.com/plandex-ai/plandex) - Open source, terminal-based AI programming engine for complex tasks. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [GitHub Copilot](https://github.com/features/copilot) - GitHub Copilot uses the OpenAI Codex to suggest code and entire functions in real-time, right from your editor. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [PR-Agent](https://github.com/Codium-ai/pr-agent) - AI-powered tool for automated PR analysis, feedback, suggestions, and more. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [MutableAI](https://mutable.ai/) - AI Accelerated Software Development.
- [TurboPilot](https://github.com/ravenscroftj/turbopilot) - A self-hosted copilot clone that uses the library behind llama.cpp to run the 6 billion parameter Salesforce Codegen model in 4 GB of RAM. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [GPT-Code UI](https://github.com/ricklamers/gpt-code-ui) - An open-source implementation of OpenAI's ChatGPT Code interpreter. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [MetaGPT](https://github.com/geekan/MetaGPT) - The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [Marblism](https://marblism.com) - Generate a SaaS boilerplate from a prompt.
- [MutahunterAI](https://github.com/codeintegrity-ai/mutahunter) - Accelerate developer productivity and code security with our open-source AI. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [AI Kernel Explorer](https://github.com/mathiscode/ai-kernel-explorer) - Explore the Linux kernel source code with AI-generated summaries. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [WhoDB](https://github.com/clidey/whodb) - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [DragGAN](https://github.com/XingangPan/DragGAN) - Drag Your GAN: Interactive Point-based Manipulation on the Generative Image Manifold. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [Stable Diffusion Models](https://rentry.org/sdmodels) - A comprehensive list of Stable Diffusion checkpoints on rentry.org. ![Static Badge](https://img.shields.io/badge/model-open_weights-brightgreen)
...
- [Teleprompter](https://github.com/danielgross/teleprompter) - An on-device AI for your meetings that listens to you and makes charismatic quote suggestions. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
- [FinChat](https://finchat.io/) - Using AI, FinChat generates answers to questions about public companies and investors.
- [Petals](https://github.com/bigscience-workshop/petals) - BitTorrent style platform for running AI models in a distributed way. ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
...
- [Harbor](https://github.com/av/harbor) - run LLM backends, APIs, frontends, and services with one command ![Static Badge](https://img.shields.io/badge/software-open_source-brightgreen)
